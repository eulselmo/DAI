...
def buscar():
	...
	if request.method == 'POST':
		...
		restaurantes=restaurants.find({'cuisine': request.form['name']})
		for restaurante in restaurantes:
			datos={'nombre': restaurante['name'], 'tipo': restaurante['cuisine'], 'direccion': restaurante['address']['street']}
			lista.append(datos)

		return render_template("buscar.html", nombre = nombre, lista = lista, titulo='Hi5', eslogan='La pagina donde te sera facil conocer gente!', correo='hi5@correo.com',direccion='C/ Hospitalet de  Lobregat s/n telefono: 9525552155')
